{{--
    Credits Plus Enhanced Navigation Component
        ...
        <div
            ...
            <div class="flex flex-row items-center">
                ...
                <div class="items-center hidden md:flex mr-1">
                    ...
                    {{-- CreditsPlus: Add clickable credits display --}}
                    @if(auth()->check() && isset($userCreditsDisplay))
                    <a href="{{ $creditsUrl ?? '/account/credits' }}" wire:navigate class="text-sm text-base hover:text-primary transition-colors duration-200 px-3 py-2 whitespace-nowrap">
                        Credits: {{ $userCreditsDisplay }}
                    </a>
                    @endif
                                ...
                                <div
                                    ...
                                    <div class="bg-background-secondary shadow-lg rounded-t-2xl border border-neutral p-6">
                                        ...
                                        <div class="mt-4 flex flex-col gap-2 w-full">
                                            {{-- CreditsPlus: Add credits display to mobile popup --}}
                                            @if(isset($userCreditsDisplay))
                                            <a href="{{ $creditsUrl ?? '/account/credits' }}" wire:navigate class="text-sm text-base hover:text-primary transition-colors duration-200 p-3 hover:bg-neutral rounded-lg">
                                                Credits: {{ $userCreditsDisplay }}
                                            </a>
                                            @endif
